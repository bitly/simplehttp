...
curl "http://localhost:8080/del?key=odd"

echo "should == '     ' not '+++++'"
curl "http://localhost:8080/put?key=plus&value=++++++"
curl "http://localhost:8080/get?key=plus"
curl "http://localhost:8080/del?key=plus"
